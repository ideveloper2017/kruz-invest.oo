    ...
    */
    ...
    'events' => [
        ...
        'beforeRenderTheme' => function (Theme $theme)
        {
            ...
            $theme->asset()->container('footer')->add('bootstrap.min', 'js/bootstrap.min.js');
            $theme->asset()->container('footer')->add('slick.min', 'js/slick.min.js');
            $theme->asset()->container('footer')->add('jquery.magnific-popup.min', 'js/jquery.magnific-popup.min.js');
            $theme->asset()->container('footer')->add('mixitup.min', 'js/mixitup.min.js');
            $theme->asset()->container('footer')->add('jquery.easypiechart.min', 'js/jquery.easypiechart.min.js');
